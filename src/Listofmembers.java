import gym_managemnt_system.Payment;
import java.sql.*;
...
public class Listofmembers extends javax.swing.JFrame {
    ...
    public Listofmembers() {
        ...
        
        {
            ...
            ResultSet rs = null;
            try {
                rs = st.executeQuery("select * from memeber");
            } catch (SQLException ex) {
                Logger.getLogger(Listofmembers.class.getName()).log(Level.SEVERE, null, ex);
            }
        while(rs.next())
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gym_managemnt_system/img/list of members.png"))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Member ID", "Name", "Mobile No", "Email", "Gender", "Father Name", "Mother Name", "GYM Time", "Adhar Card No.", "Age", "Amount"
            }
        ));
